...
export function DemoRouter(): NixTemplate {
  ...
  const routes: Route[] = [
    ...
    { path: '/about', render: () => html`<div><h4 style="font-family:var(--head);font-size:16px;color:#fff;margin-bottom:6px">📄 About</h4><p style="color:var(--tx2);font-size:13px">Nix.js — a signal-based micro-framework. v2.5.3</p></div>` },

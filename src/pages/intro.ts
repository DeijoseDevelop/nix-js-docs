...
export function IntroPage(): NixTemplate {
  ...
  return html`
    <div>
      <div class="hero">
        <div class="eyebrow">Documentation · v1.8.1</div>
        <h1>Nix<em>.</em>js</h1>
        ...
        <div class="hero-tags">
          <span class="badge"><span class="bdot" style="background:var(--green)"></span>462 tests passing</span>
      <span class="badge"><span class="bdot" style="background:var(--green)"></span>97% Coverage</span>

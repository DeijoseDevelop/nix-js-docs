...
export const PAGES: PageMeta[] = [
  ...
  { id: 'query', label: 'Nix.js Query', grp: 'Ecosystem' },
  { id: 'ionic', label: 'Nix.js Ionic', grp: 'Ecosystem' },
  { id: 'auth', label: 'Nix.js Auth', grp: 'Ecosystem' },
  { id: 'i18n', label: 'Nix.js I18n', grp: 'Ecosystem' },
  { id: 'hmr', label: 'Vite Plugin', grp: 'Tooling' },
